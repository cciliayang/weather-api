...
class WeatherServiceTest {
    ...
    public void test_should_return_weather_response() throws Exception {
        ...
        assertAll("Should return city weather response",
                ...
                ()-> assertEquals(DETAILS, weatherResponse.getDescription()));
    ...
    private void mockOpenWeatherTransformer() {
        ...
        when(openWeatherTransformer.convertToWeatherResponseEntity(any())).thenReturn(weatherResponse);
    }
    ...
    private void mockGeocodingCoordinatesTransformer() {
        ...
        when(geocodingCoordinatesTransformer.mapToDomain(any())).thenReturn(cityCoordinates);
    }
